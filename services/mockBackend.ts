...
export const apiGetFeatures = async (tenantId: string): Promise<ApiResponse<any>> => {
  ...
  // Filter only true features as per common REST patterns for feature flags, or return all with bools.
  // Prompt asked to return "features liberadas" (released features).
