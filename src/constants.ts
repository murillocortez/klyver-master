...
export const MOCK_TENANTS: Tenant[] = [
  {
    id: '1',
    slug: 'farmacia-sao-joao',
    tenant_id: 'FV-1001-ABCD',
    apiKey: 'FV-KEY-1001-SECURE-HASH',
  ...
  },
  {
    ...
    apiKey: 'FV-KEY-1002-SECURE-HASH',
  ...
  {
    id: '3',
    slug: 'farmavida-economica',
    tenant_id: 'FV-1003-PEND',
    apiKey: 'FV-KEY-1003-SECURE-HASH',
  ...
  {
    id: '4',
    slug: 'farmacia-popular-centro',
    tenant_id: 'FV-1004-BLCK',
    apiKey: 'FV-KEY-1004-SECURE-HASH',
