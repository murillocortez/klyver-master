...
export interface Tenant {
  ...
  // Subscription Info
  planCode: string; // mapped from plan_code
  status: TenantStatus;

  // URLs
  adminBaseUrl?: string; // mapped from admin_base_url
  storeBaseUrl?: string; // mapped from store_base_url
  ...
  apiKey?: string; // mapped from api_key
  onboardingStatus?: 'pending' | 'completed'; // mapped from onboarding_status
}
